...
export const Icons = {
  ...
  Transactions: (p) => <Icon {...p} d={['M8 6h13','M8 12h13','M8 18h13','M3 6h.01','M3 12h.01','M3 18h.01']} />,
  ...
  Predictions:  (p) => <Icon {...p} d={['M22 12h-4l-3 9L9 3l-3 9H2']} />,
  ...
  Knowledge:    (p) => <Icon {...p} d={['M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z']} />,
  ...
  Roster:       (p) => <Icon {...p} d={['M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2','M9 11a4 4 0 100-8 4 4 0 000 8z','M23 21v-2a4 4 0 00-3-3.87','M16 3.13a4 4 0 010 7.75']} />,
