    ...
    <aside className="fixed top-0 left-0 h-full w-56 bg-fb-sidebar border-r border-fb-border flex flex-col z-40">
      <div className="flex flex-col items-center gap-3 px-5 py-5 border-b border-fb-border">
        <div className="w-24 h-24 flex items-center justify-center flex-shrink-0">
          <img src="/HiveNetLogo.png" alt="HiveNet Logo" className="w-24 h-24 object-contain" />
        </div>
        <div className="text-center">
          <div className="text-sm font-bold text-fb-text tracking-tight">LogBot</div>
          <div className="text-[10px] text-fb-muted">Supply Chain AI</div>
        </div>
      </div>
